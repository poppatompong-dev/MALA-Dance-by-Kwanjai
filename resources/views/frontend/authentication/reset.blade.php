...
<head>
    ...
    <title>
        รีเซ็ตรหัสผ่าน | {{ readConfig('site_name') }}
    </title>
    <!-- FAVICON ICON -->
...
<body>
    ...
    <section class="authentications">
        <div class="left-content">
            <figure class="">
                <img src="{{ asset('assets/images/demo/auth/reset.svg') }}" alt="ภาพรีเซ็ตรหัสผ่าน">
            </figure>
        </div>
        <div class="right-content">
            <form action="{{ route('password.reset') }}" method="post" class="authentication-form px-lg-5 forgot-form">
                ...
                <div class="authentication-form-footer">
                    <p>ไม่ได้รับอีเมล? คลิกเพื่อ <a href="{{ route('resend.otp') }}">ส่งอีกครั้ง</a></p>
