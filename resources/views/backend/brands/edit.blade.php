...
@section('title', 'แก้ไขแบรนด์/แหล่งสินค้า')
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="mb-3 col-md-6">
            ...
            <div class="image-upload-container" id="imageUploadContainer">
              ...
              <div class="thumb-preview" id="thumbPreviewContainer">
                <img src="{{ mediaImage($brand->image) }}" alt="ตัวอย่างรูปแบรนด์"
          ...
          <div class="mb-3 col-md-12">
            ...
            <textarea class="form-control" placeholder="รายละเอียดแบรนด์/แหล่งสินค้า" name="description">{{ old('description',$brand->description) }}</textarea>
          </div>
          <div class="mb-3 col-md-12">
