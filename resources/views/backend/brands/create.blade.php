...
@section('title', 'เพิ่มแบรนด์/แหล่งสินค้า')
  ...
  <div class="card-body">
    <form action="{{ route('backend.admin.brands.store') }}" method="post" class="accountForm"
      ...
      <div class="card-body">
        <div class="row">
          <div class="mb-3 col-md-6">
            <label for="title" class="form-label">
              ชื่อแบรนด์/แหล่งสินค้า
              <span class="text-danger">*</span>
            </label>
            <input type="text" class="form-control" placeholder="เช่น ครัวกลาง" name="name"
          ...
          <div class="mb-3 col-md-6">
            ...
            <div class="image-upload-container" id="imageUploadContainer">
              ...
              <div class="thumb-preview" id="thumbPreviewContainer">
                <img src="{{ asset('assets/images/demo/no-image.svg') }}" alt="ตัวอย่างรูปแบรนด์"
          ...
          <div class="mb-3 col-md-12">
            ...
            <textarea class="form-control" placeholder="รายละเอียดแบรนด์/แหล่งสินค้า" name="description">{{ old('description') }}</textarea>
          </div>
          <div class="mb-3 col-md-12">
        ...
        <div class="row">
          <div class="col-md-6">
            <button type="submit" class="btn bg-gradient-primary">บันทึกแบรนด์</button>
          </div>
        </div>
      </div>
    </form>
